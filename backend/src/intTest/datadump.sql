...
--
-- Host: localhost    Database: ljps_db_test
-- ------------------------------------------------------
...
CREATE TABLE `course_skill` (
  ...
  KEY `course_skill_fk2` (`Course_ID`),
...
--
-- Table structure for table `job_role_skill`
--
...
CREATE TABLE `job_role_skill` (
  ...
  KEY `job_role_skill_fk2` (`Skill_ID`),
...
--
-- Dumping data for table `job_role_skill`
--
...
CREATE TABLE `learning_journey` (
  ...
  KEY `learning_journey_fk1` (`Staff_ID`),
...
CREATE TABLE `learning_journey_course` (
  ...
  KEY `learning_journey_course_fk2` (`Course_ID`),
...
CREATE TABLE `learning_journey_skill` (
  ...
  KEY `learning_journey_skill_fk2` (`Skill_ID`),
...
CREATE TABLE `registration` (
  ...
  PRIMARY KEY (`Reg_ID`),
  KEY `registration_fk1` (`Course_ID`),
